...
const initialSuggestions = [
  ...
  {
  id: 4,
  title: "1 viral hook formula for Reels",
  hook: "Use this hook template to boost watch time instantly.",
  topics: ["Hooks", "Reels Strategy", "Growth"],
  platforms: ["Instagram"],
  postType: "Reel",
  goal: "More Views",
  difficulty: "Medium",
  ...
  media: {
    ...
    durationSec: 25,
    aspectRatio: "9:16",
    shotList: ["Hook example", "Explain template", "Show example", "CTA"],
    bRollIdeas: ["text overlays", "quick cuts"],
  },
  hashtags: ["#reels", "#growthtips", "#viral"],
  externalLinks: [],
  status: "NEW",
},
{
  id: 5,
  title: "Carousel: 5-step content system",
  hook: "This system generates leads every week.",
  topics: ["Content Strategy", "Leads", "System"],
  ...
  media: {
    ...
    durationSec: null,
    aspectRatio: "1:1",
    shotList: ["Hook slide", "Step 1–5 slides", "CTA slide"],
    bRollIdeas: [],
  },
  hashtags: ["#contentmarketing", "#leadgen"],
  externalLinks: [],
  status: "NEW",
},
{
  id: 6,
  title: "YouTube Short: 1 productivity hack",
  hook: "This saves me 2 hours every day.",
  topics: ["Productivity", "Quick Hack"],
  platforms: ["YouTube"],
  postType: "Short",
  goal: "More Views",
  difficulty: "Easy",
  ...
  media: {
    ...
    durationSec: 20,
    aspectRatio: "9:16",
    shotList: ["Problem", "Hack demo", "Result", "CTA"],
    bRollIdeas: ["before/after"],
  },
  hashtags: ["#youtubeshorts", "#productivity"],
  externalLinks: [],
  status: "NEW",
},
{
  id: 7,
  title: "Authority-building LinkedIn post",
  hook: "Here’s what 3 years in this field taught me.",
  topics: ["Authority", "Experience", "Lead Gen"],
  platforms: ["LinkedIn"],
  postType: "Post",
  goal: "More Leads",
  difficulty: "Medium",
  ...
  media: {
    ...
    durationSec: null,
    aspectRatio: null,
    shotList: ["Hook", "3 insights", "CTA"],
    bRollIdeas: [],
  },
  hashtags: ["#linkedinpost", "#leadgeneration"],
  externalLinks: [],
  status: "NEW",
},
];
